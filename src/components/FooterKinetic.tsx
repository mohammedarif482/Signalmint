...
export function FooterKinetic({ onOpenDemoModal: _onOpenDemoModal, onOpenInnerPage: _onOpenInnerPage, onNavigateHomeAnchor }: FooterKineticProps) {
  ...
  return (
    <footer className="relative w-full footer-separated-bg text-[#1A0042] pt-12 sm:pt-16 pb-0 overflow-hidden border-t-2 border-[#573681]/25 selection:bg-[#573681] selection:text-white shadow-[0_-12px_40px_rgba(87,54,129,0.05)]">
