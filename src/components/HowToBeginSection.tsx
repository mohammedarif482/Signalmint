    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            ref={card1Ref}
            className="absolute inset-0 rounded-[2rem] sm:rounded-[2.5rem] p-5 xs:p-6 sm:p-8 bg-gradient-to-br from-[#6366F1] via-[#573681] to-[#3B1F69] text-white shadow-[0_20px_50px_-15px_rgba(87,54,129,0.45)] border border-white/25 flex flex-col justify-between overflow-hidden will-change-transform"
          >
            {/* Top Text Content */}
          ...
          <div
            ref={card2Ref}
            className="absolute inset-0 rounded-[2rem] sm:rounded-[2.5rem] p-5 xs:p-6 sm:p-8 bg-gradient-to-br from-[#2563EB] via-[#4338CA] to-[#573681] text-white shadow-[0_20px_50px_-15px_rgba(37,99,235,0.40)] border border-white/25 flex flex-col justify-between overflow-hidden will-change-transform"
          >
            {/* Top Text Content */}
            <div className="relative z-10 space-y-1.5 sm:space-y-2">
              <div className="flex items-center justify-between">
          ...
          <div
            ref={card3Ref}
            className="absolute inset-0 rounded-[2rem] sm:rounded-[2.5rem] p-5 xs:p-6 sm:p-8 bg-gradient-to-br from-[#7C3AED] via-[#573681] to-[#43236B] text-white shadow-[0_20px_50px_-15px_rgba(124,58,237,0.40)] border border-white/25 flex flex-col justify-between overflow-hidden will-change-transform"
          >
            {/* Top Text Content */}
            <div className="relative z-10 space-y-1.5 sm:space-y-2">
              <div className="flex items-center justify-between">
          ...
          <div
            ref={card4Ref}
            className="absolute inset-0 rounded-[2rem] sm:rounded-[2.5rem] p-5 xs:p-6 sm:p-8 bg-gradient-to-br from-[#8B5CF6] via-[#573681] to-[#1A0042] text-white shadow-[0_20px_50px_-15px_rgba(139,92,246,0.45)] border border-white/25 flex flex-col justify-between overflow-hidden will-change-transform"
          >
            {/* Top Text Content */}
            <div className="relative z-10 space-y-1.5 sm:space-y-2">
              <div className="flex items-center justify-between">
